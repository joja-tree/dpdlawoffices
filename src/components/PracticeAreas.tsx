...
const PracticeAreas: React.FC = () => {
  ...
  return (
    <section id="practice-areas" className="bg-slate-100 py-16 md:py-24">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-slate-800 mb-4">Our Practice Areas</h2>
          <p className="max-w-2xl mx-auto text-slate-600">We offer comprehensive legal services across multiple practice areas, delivering expert guidance tailored to your specific needs.</p>
        </div>
