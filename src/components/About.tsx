...
const About: React.FC = () => {
  return (
    <section id="about" className="py-16 md:py-24 bg-white text-dark">
        ...
        <div className="flex flex-col lg:flex-row items-center gap-12">
          <div className="lg:w-1/2">
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -right-6 bg-primary text-white p-6 rounded shadow-lg">
          ...
          <div className="lg:w-1/2">
            <h2 className="text-3xl text-dark md:text-4xl font-serif font-bold mb-6">About Our Firm</h2>
            <p className="text-light mb-4">
              Founded in 1995, DPD Law Offices has established itself as a trusted name in legal services. Our firm combines decades of experience with innovative approaches to deliver exceptional results for our clients.
            </p>
