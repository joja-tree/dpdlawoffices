      ...
      <div className="container mx-auto px-4 md:px-6 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 md:gap-12 mb-12">
          ...
          <div>
            ...
            <address className="text-light not-italic space-y-2">
              <p>Address Pending</p>
        ...
        <div className="pt-8 border-t border-gray-800 text-light flex flex-col md:flex-row justify-between items-center">
