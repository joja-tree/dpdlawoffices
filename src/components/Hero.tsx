...
const Hero: React.FC = () => {
  return (
    <section id="home" className="relative bg-dark pt-20">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-6 py-20 md:py-32">
        <div className="max-w-3xl">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white leading-tight mb-6">
            Legal Excellence with <span className="text-primary">Personal Touch</span>
          </h1>
          <p className="text-xl text-light mb-8 max-w-2xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a 
              href="#contact" 
              className="inline-block bg-primary hover:bg-primary-dark text-white font-medium py-3 px-6 rounded shadow-lg hover:shadow-xl transition-all duration-300 text-center"
            >
              Free Consultation
            </a>
            <a 
      ...
      <div className="absolute bottom-0 left-0 right-0 h-16 bg-gradient-to-t"></div>
    </section>
  );
};
