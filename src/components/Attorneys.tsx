      ...
      <div className="p-6">
        ...
        <div className="flex flex-wrap gap-2 mt-4">
          {specialties.map((specialty, index) => (
            <span key={index} className="text-xs bg-gray-50 text-light px-3 py-1 rounded-full">
              {specialty}
            </span>
          ))}
        </div>
...
const Attorneys: React.FC = () => {
  ...
  return (
    <section id="attorneys" className="py-16 md:py-24 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        <div className="text-center mb-12 md:mb-16">
          <h2 className="text-3xl md:text-4xl font-serif font-bold text-dark mb-4">Our Attorneys</h2>
          <p className="max-w-2xl mx-auto text-light">Meet our exceptional team of legal experts dedicated to providing you with the highest quality representation and counsel.</p>
        </div>
